        ...
        <div className="hero-content max-w-full flex-col-reverse md:gap-8 md:flex-row-reverse ">
          ...
          <div className="w-full md:w-3/5  space-y-3 ">
            ...
            <p className="text-justify ">
              ...
              Gym activities in a planned way so that your fitness may not face
              any obstacles and you may get maximum benefits from Platinum
              Fitness. Our Aspire is to give you proper guideline about your
              physical health which will help you to maintain a sound mind in a
              sound body. So be our mates and enjoy the pleasure of healthy
              life.
            </p>
          </div>
        </div>
